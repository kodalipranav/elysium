...
class AddPost extends StatefulWidget {
  const AddPost({required this.orgName, super.key});
...
class _AddPostState extends State<AddPost> {
  ...
  Future<void> addNewPost() async {
    ...
    if (checkLocation()) {
      if (!isRecurring) {
        if (titleController.text.isNotEmpty && descriptionController.text.isNotEmpty && oneStartDate != null && oneEndTime != null
          && oneStartTime != null && locationController.text.isNotEmpty && contactNameController.text.isNotEmpty && 
          contactInfoController.text.isNotEmpty && dateClosed != null) {
            await FirebaseFirestore.instance.collection('non_recurring').add({
        ...
        if (sameTimes) {
          if (selectedStartTime != null && selectedEndTime != null && selectedDays.isNotEmpty) {
            for (var day in selectedDays) {schedule[day]![0] = selectedStartTime; schedule[day]![1] = selectedEndTime;}
          } else {
            showAlert();
          }
        }
        if (titleController.text.isNotEmpty && descriptionController.text.isNotEmpty && selectedStartDate != null && selectedEndDate != null
          && checkSchedule() && locationController.text.isNotEmpty && contactNameController.text.isNotEmpty && 
          contactInfoController.text.isNotEmpty && dateClosed != null) {
            Map correctedSchedule = correctSchedule();
            await FirebaseFirestore.instance.collection('recurring').add({
              'org_name' : widget.orgName,
              'title' : titleController.text,
              'description': descriptionController.text,
              'requirements': converted,
              ...
              child: Column(
                children: [
                  Column(
                    ...
                    children: [
                      Text('Add a New Post', style: GoogleFonts.montserrat(fontSize: 24, fontWeight: FontWeight.bold)),
                      const SizedBox(height: 16),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text('Recurring Post', style: GoogleFonts.montserrat(fontSize: 18, fontWeight: FontWeight.w600)),
                          Row(
                            children: [
                              ElevatedButton(
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: !isRecurring ? Colors.brown : Colors.grey[400],
                                  foregroundColor: !isRecurring ? Colors.white : Colors.black,
                                      ...
                                      child: MaterialButton(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                            Text(
                                              oneStartTime == null ? "Start Time" : oneStartTime!.format(context), 
                                ...
                                Row(children: [
                                  Expanded(
                                    ...
                                    child: Padding(
                                      ...
                                      child: MaterialButton(
                                        color: Colors.brown[100],
                                        onPressed: () {selectDate(context, isStartDate: true, recur: isRecurring);},
                                        child: Padding(
                                      ...
                                      padding: const EdgeInsets.all(5),
                                        ...
                                        child: Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                            Text(
                                              oneEndTime == null ? "End Time" : oneEndTime!.format(context),
                                              style: GoogleFonts.montserrat(fontSize: 14)
                                            )
                                          ],),
                                        )),
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                child: MaterialButton(
                                  color: Colors.brown[100],
                                  onPressed: () => selectDate(context, isStartDate: false, recur: isRecurring),
                                  child: Text(
